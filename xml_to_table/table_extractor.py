...
if __name__ == "__main__":
    ...
    print(xml_to_table('/data1/saltlux/CJPoc/table-extraction/final_demo/task2_216/xml_cj_78/Gsес_deficiency_in_the_dorsomedial_hypothalamus_leads_to_obesity,_hyperphagia,_and_reduced_thermogenesis_associated_with_impaired_leptin_signaling.xml'))
